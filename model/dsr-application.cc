...
DsrApplication::Setup (Ptr<Socket> socket, Address address, uint32_t packetSize, uint32_t nPackets, DataRate dataRate, uint32_t budget, bool flag)
{
 ...
 void
DsrApplication::TCPSetup (Ptr<Socket> socket, Address address, uint32_t packetSize, uint32_t nPackets, uint32_t budget, bool flag)
{
    m_socket = socket;
    m_peer = address;
    m_packetSize = packetSize;
 ...
 void
 DsrApplication::TCPSetup (Ptr<Socket> socket, Address address, uint32_t packetSize, uint32_t nPackets, bool flag)
 {
    m_socket = socket;
    m_peer = address;
    m_packetSize = packetSize;
