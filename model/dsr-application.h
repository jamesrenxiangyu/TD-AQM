...
public:
  ...
  void TCPSetup (Ptr<Socket> socket, Address address, uint32_t packetSize, uint32_t nPackets,  uint32_t budget, bool flag);
  void TCPSetup (Ptr<Socket> socket, Address address, uint32_t packetSize, uint32_t nPackets, bool flag);
